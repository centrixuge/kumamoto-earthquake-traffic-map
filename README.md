...
- 区間の座標は公表されていないため**線としては描けません**。代わりに、その規制が掛かっていた観測点の**すぐ上**に **▲**（規制を指す印）を置いた別レイヤにしています。観測点の丸とは重ならない高さに出しており、**区間そのものを表す図形ではありません**
- 該当観測点を選んだとき、**時系列図に通行止め期間の帯**を表示します
- 地図の下に出典PDFへのリンク付きで一覧を出します

現在転記済みの規制（2026-07-29 22時時点で公表されていた12件のPDFをすべて転記。road4 は欠番）:

| 路線 | 区間・地点 | 規制内容 | 期間 | 対応する観測点 |
| --- | --- | --- | --- | --- |
| 九州中央自動車道 | 小池高山IC〜山都通潤橋IC（約23km） | 全面通行止め | 07-28 16:27 〜 07-29 03:00 | なし（路線上に観測点なし） |
| 国道57号 北側復旧道路 | 車帰IC〜大津IC（約10km） | 全面通行止め | 07-28 16:27 〜 07-29 02:00 | **9310127** |
| 国道57号 北側復旧道路 | 阿蘇西IC〜車帰IC（約3km） | 全面通行止め | 07-28 16:27 〜 07-29 08:00 | なし（区間内に観測点なし） |
| 国道3号 | 八代郡氷川町大野（216K600） | 全面通行止め | 07-28 20:30 〜 07-29 00:30 | 特定できず |
| 国道57号 | 宇土市住吉（133K450） | 片側交互通行規制 | 07-28 16:27 〜 07-29 16:30 | 特定できず |
