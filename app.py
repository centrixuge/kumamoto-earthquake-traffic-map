...
# 赤・橙は通行規制（全面通行止め #e60000 / 片側交互 #e67e22）、
# 青系は観測点マーカーの異常度グラデーション（#deebf7〜#08306b）で
# 使っているため、それらと被らない青緑と紫にしている。
SELECTION_COLORS = ["#1b9e77", "#7b3fa0"]
        ...
        if post.empty:
            ...
            with col_map:
                ...
                st.caption(
                    ...
                    "選択中の観測点は青緑/紫の枠で強調表示され、時系列の折れ線も同じ色になります（最大2地点）。"
